...
export default function AuthRegister({ onNavigate }) {
  ...
  const getPasswordStrength = () => {
    if (!password) return { percent: 0, label: 'NONE', color: 'text-white/20', bg: 'bg-white/10' };
    if (password.length < 6) return { percent: 1, label: 'WEAK', color: 'text-error font-bold', bg: 'bg-error/30' };
    if (password.length < 10) return { percent: 2, label: 'MODERATE', color: 'text-secondary font-bold', bg: 'bg-secondary/30' };
    return { percent: 4, label: 'OPTIMAL', color: 'text-tertiary font-bold', bg: 'bg-tertiary/30' };
  };
        ...
        >
          ...
          <div className="text-left flex flex-col gap-1.5">
            ...
            <p className="text-on-surface-variant text-xs font-sans">
              Enter credentials to establish a new autonomous core.
            </p>
          </div>
          ...
          <form onSubmit={handleFormSubmit} className="flex flex-col gap-4.5 text-left">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="flex flex-col gap-1.5">
                <label className="font-mono text-[9.5px] text-on-surface-variant uppercase tracking-widest px-1">Full Name</label>
            ...
            {/* Email Address */}
            <div className="flex flex-col gap-1.5">
              <label className="font-mono text-[9.5px] text-on-surface-variant uppercase tracking-widest px-1">Email Node</label>
              <div className="relative group">
                <div className="absolute inset-y-0 left-4 flex items-center pointer-events-none text-on-surface-variant/30 group-focus-within:text-tertiary transition-colors">
            ...
            {/* Password */}
            <div className="flex flex-col gap-1.5">
              <label className="font-mono text-[9.5px] text-on-surface-variant uppercase tracking-widest px-1">Password</label>
              <div className="relative group">
                <div className="absolute inset-y-0 left-4 flex items-center pointer-events-none text-on-surface-variant/30 group-focus-within:text-tertiary transition-colors">
