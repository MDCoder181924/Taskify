...
export default function Hero() {
  ...
  return (
    <section 
      ...
      style={{
        backgroundImage: `radial-gradient(circle at ${mousePos.x}% ${mousePos.y}%, rgba(192, 193, 255, 0.08) 0%, transparent 60%)`
      }}
    >
      ...
      <div className="flex flex-col gap-8 reveal active">
        ...
        <h1 className="font-display font-extrabold text-5xl md:text-6xl lg:text-[4.5rem] leading-[1.05] tracking-tight text-white select-none">
          Manage Work <br/>
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary via-secondary to-tertiary drop-shadow-[0_0_20px_rgba(192,193,255,0.2)]">
            Smarter with AI
          </span>
        </h1>
        ...
        <div className="flex flex-wrap gap-4 pt-4">
          <Link to="register" className="relative group px-8 py-4 rounded-xl font-sans font-bold text-sm text-[#0b1326] bg-gradient-to-r from-primary to-secondary shadow-xl shadow-primary/20 transition-all duration-300 hover:scale-105 active:scale-95">
          ...
          <button className="glass-card px-8 py-4 rounded-xl flex items-center gap-2 font-sans font-bold text-sm text-white hover:bg-white/10 border-white/10 hover:border-white/25 transition-all duration-300 active:scale-95">
            <Play className="w-4 h-4 text-tertiary fill-tertiary" />
            Watch Demo
          </button>
        </div>
      ...
      <div className="relative flex items-center justify-center py-10 lg:py-0">
        ...
        {/* Glow behind card */}
        <div className="absolute inset-0 bg-gradient-to-tr from-primary/10 via-secondary/5 to-transparent blur-3xl rounded-full scale-75 animate-pulse" />
        ...
        <div 
          className={`relative glass-card p-3 rounded-[2.2rem] border-white/15 overflow-visible aspect-square w-full max-w-[460px] flex items-center justify-center transition-shadow duration-500 group ${
            hovered 
              ? 'shadow-[0_40px_80px_rgba(192,193,255,0.18)] border-primary/20' 
        ...
        >
          {/* Card Image */}
          <div className="relative rounded-2xl w-full h-full overflow-hidden border border-white/10 bg-[#060e20]">
            <img 
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-[#0b1326]/60 via-transparent to-transparent pointer-events-none" />
          </div>
